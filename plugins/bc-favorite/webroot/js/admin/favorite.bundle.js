...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    refresh: function refresh() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(indexUrl).then(function (response) {
  ...
  function() {
    ...
    return _c("dd", [
      _c("input", {
        ...
        attrs: { type: "text", size: "30", name: "name" }
      })
    ])
  },
  function() {
    ...
    return _c("dd", [
      _c("input", {
        staticClass: "required",
        attrs: { type: "text", size: "30", name: "url" }
      })
    ])
  }
]
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _favorites_index_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./favorites/index.vue */ "./webroot/js/src/admin/favorites/index.vue");
/**
          ...
          $.bcToken.check(function () {
            ...
            return $("#FavoriteAjaxForm").ajaxSubmit({
              ...
              success: function success(response, status) {
                _favorites_index_vue__WEBPACK_IMPORTED_MODULE_0__["default"].methods.refresh(); // app.$children[0].refresh();

                $("#FavoriteDialog").dialog('close'); // if (response) {
                //     if ($("#FavoriteId").val()) {
